...
export const FirstSection = ({ getData, updateData }) => {
  ...
  return (
    <div className="min-h-screen  w-full bg-bgHomeFirst bg-cover bg-center bg-no-repeat ">
      <div className="flex text-white ">
        <div className="sm:mx-16 mx-10 mt-28 lg:mt-40 flex flex-col gap-5 trasition ease-out duration-500">
